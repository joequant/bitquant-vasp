...
We will allow staff to engage in work outside of the firm provided
...
In situations where there is a requirement for multisignature wallet
...
staff, and we will inform the SFC and our EAR2 report reviwers of the
...
compliance officer will exercises the duties of the managing director
in his absence.
...
have access to the custody cold wallets in a manner that would allow a
single person to gain access over client funds.

\section{Financial resources}
\subsection{Liquid Capital Requirements}
\crossref{VA-1: Question 6, VASP Guidelines Section 6.1 and 6.2}
...
\begin{figure}[h]
  ...
  \begin{tabular}{lr}
    ...
    Client virtual assets (in segregrated accounts) & HKD 3,000,000 \\
    \midrule
